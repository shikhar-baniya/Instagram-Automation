    ...
    <div className="flex-1 pr-4 space-y-6 overflow-y-auto h-full pb-20 custom-scrollbar">
      ...
      <section className="macos-glass-panel p-6 rounded-3xl relative overflow-hidden shadow-sm">
        ...
        <div className="space-y-3">
          <label 
            onClick={() => setFormData({...formData, target_story_type: 'specific'})}
            className={`flex items-center justify-between p-4 border rounded-2xl cursor-pointer transition-all duration-300 ${formData.target_story_type === 'specific' ? 'border-blue-500/50 bg-blue-500/5 shadow-[0_0_15px_rgba(59,130,246,0.1)]' : 'border-white/10 hover:bg-white/5 bg-black/20'}`}>
          ...
          <label 
            onClick={() => setFormData({...formData, target_story_type: 'next'})}
            className={`flex items-center justify-between p-4 border rounded-2xl cursor-pointer transition-all duration-300 ${formData.target_story_type === 'next' ? 'border-blue-500/50 bg-blue-500/5 shadow-[0_0_15px_rgba(59,130,246,0.1)]' : 'border-white/10 hover:bg-white/5 bg-black/20'}`}>
          ...
          <label 
            onClick={() => setFormData({...formData, target_story_type: 'any'})}
            className={`flex items-center justify-between p-4 border rounded-2xl cursor-pointer transition-all duration-300 ${formData.target_story_type === 'any' ? 'border-blue-500/50 bg-blue-500/5 shadow-[0_0_15px_rgba(59,130,246,0.1)]' : 'border-white/10 hover:bg-white/5 bg-black/20'}`}>
